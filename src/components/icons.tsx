...
export const Threads = (p: IconProps) => (
  <Brand {...p}>
    <path d="M16.1 11.15a6.2 6.2 0 0 0-.24-.11c-.14-2.6-1.56-4.09-3.95-4.1h-.03c-1.43 0-2.62.61-3.35 1.72l1.31.9c.55-.83 1.4-1 2.04-1h.02c.8 0 1.4.24 1.79.69.28.33.47.79.57 1.37a10.3 10.3 0 0 0-2.3-.11c-2.32.13-3.81 1.49-3.71 3.37.05.96.53 1.78 1.35 2.31.7.45 1.59.67 2.52.62 1.23-.07 2.2-.54 2.87-1.4.51-.65.84-1.5.98-2.56.6.36 1.04.83 1.29 1.4.42.97.44 2.56-.86 3.85-1.14 1.14-2.51 1.63-4.58 1.65-2.3-.02-4.03-.75-5.16-2.18-1.06-1.34-1.6-3.27-1.62-5.74.02-2.47.56-4.4 1.62-5.74C7.79 4.73 9.53 4 11.82 3.98c2.31.02 4.08.76 5.25 2.19.58.71 1.01 1.6 1.3 2.63l1.54-.41c-.35-1.27-.9-2.37-1.64-3.27C16.77 3.28 14.57 2.34 11.83 2.32h-.01c-2.74.02-4.91.96-6.46 2.8C3.98 6.75 3.27 9.05 3.25 11.99v.02c.02 2.94.73 5.24 2.11 6.87 1.55 1.84 3.72 2.78 6.46 2.8h.01c2.43-.02 4.15-.66 5.56-2.07 1.85-1.85 1.8-4.17 1.19-5.59-.44-1.02-1.27-1.85-2.4-2.4l-.08-.04Zm-3.77 3.98c-1.03.06-2.1-.4-2.15-1.4-.04-.74.53-1.57 2.22-1.67l.44-.01c.55 0 1.07.05 1.54.16-.18 2.18-1.2 2.87-2.05 2.92Z" />
  </Brand>
);
