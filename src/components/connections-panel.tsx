      ...
      <form onSubmit={invite} className="mt-4 flex flex-wrap items-center gap-2">
        ...
        <div className="relative min-w-[240px] flex-1">
          ...
          <input
            ...
            className="w-full min-h-[44px] rounded-xl border border-line pl-9 pr-3.5 py-2.5 text-[15px] text-on-card outline-none transition-colors focus:border-line-focus"
          />
        </div>
        <button
          type="submit"
